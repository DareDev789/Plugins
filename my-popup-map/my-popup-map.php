...
function my_popup_map_html() {
    ...
    <div id="my-popup-overlay" onclick="closeMap()" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background-color:rgba(0,0,0,0.5); z-index:9998;"></div>
    <div id="my-popup" style="display:none; position:fixed; top:50%; left:50%; transform:translate(-50%, -50%); width:80%; height:auto; background-color:white; z-index:999999; padding:0px; box-shadow:0 0 10px rgba(0,0,0,0.5);">
        <!-- Div superposée pour les boutons -->
        <div style="position: absolute; top: 0px; left: 50%; transform: translate(-50%, 0); display: inline-flex; flex-wrap: nowrap; z-index: 5000">
            <div>
                <button disabled style="color: #707070 !important; background: #fff !important; border: none; white-space: nowrap; font-size: 1.5vw;" id="listeVille" onclick="toggleMap()">
                    <i class="fas fa-list"></i> <span class="">Liste des villes</span>
                </button>
            </div>
            <div>
                <button style="color: #fff !important; background: #f5848c !important; border: none; white-space: nowrap; font-size: 1.5vw;" id="carteVille" onclick="toggleMap()">
        ...
        <!-- Première map -->
        <div id="map1" style="width:100%; height:65vh; position:relative; margin:0px; padding:10px; overflow:auto; display:none;">
        ...
        <div id="mapvers2" style="width:100%; position:relative;">
            <div class="row" style="align-items: center position: relative; max-height : 80vh; overflow: auto; padding-top : 35px !important;  padding:15px 5px; background-image: url('<?php echo plugins_url('fond.webp', __FILE__); ?>'); background-position:center right; background-size:cover;">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 content_list_ville" style="padding: 2px 5px; position : relative">
                    <h2 style="font-size:1.5em; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.7); color : #f5848c; font-weight : 700">Déjà disponible dans plusieurs villes de Madagascar</h2>
                    <div class="elementor-widget-container">
                        <p style="color:#fff;" class="Acacher">Qu’il s’agisse de courses alimentaires, de matériaux de construction pour vos projets à Madagascar, de cadeaux mode ou de préparation d’événements locaux, vous trouverez tout ce dont vous avez besoin sur Sendbazar.</p>
                        <hr><p style="color:#fff;">Choisissez votre ville de livraison !</p>
                    </div>
        ...
        <!-- Bouton de fermeture -->
        <button onclick="closeMap()" style="position:absolute; top:-10px; right:-10px; background:red; border-radius: 50%; z-index:99990;">X</button>
    </div>
    <?php
}
